...
public class SaveImage extends CordovaPlugin {
     ...
     * args[1] albumName        optional album name in the gallery
     */  
    private void saveImageToGallery(JSONArray args, CallbackContext callback) throws JSONException {
    	...
    	if (args.opt(1) instanceof String) {
    	    this.albumName = args.getString(1);
        }
    ...
    private void performImageSave() throws JSONException {
        ...
        File dstGalleryFolder;
        if (filePath == null || filePath.equals("")) {
            dstGalleryFolder = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES);
        } else {
            dstGalleryFolder = new File(
