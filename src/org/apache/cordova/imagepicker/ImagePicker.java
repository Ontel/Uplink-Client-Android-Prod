package org.apache.cordova.imagepicker;
    ...
    */
    ...
    private String copyFileToInternalStorage(Uri uri, String newDirName) {
        ...
        try {
            ...
            (Toast.makeText(context, FILE_ACCESS_ERROR, Toast.LENGTH_LONG)).show();
    ...
    private void showMaxLimitWarning() {
        ...
        (Toast.makeText(cordova.getActivity(), toastMsg, Toast.LENGTH_LONG)).show();
    }
}
