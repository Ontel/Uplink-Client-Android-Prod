...
ImagePicker.prototype.hasReadPermission = function(callback) {
	return exec(callback, null, "ImagePicker", "hasReadPermission", []);
};

ImagePicker.prototype.requestReadPermission = function(callback, failureCallback) {
	return exec(callback, failureCallback, "ImagePicker", "requestReadPermission", []);
};

ImagePicker.prototype.closeImagePicker = function(callback) {
	return exec(callback, null, "ImagePicker", "closeImagePicker", []);
};
...
ImagePicker.prototype.getPictures = function(success, fail, options) {
	...
	return exec(success, fail, "ImagePicker", "getPictures", [params]);
};
